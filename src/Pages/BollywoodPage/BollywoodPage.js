...
import {BollywoodQuestion} from '../../RecoilState/BollywoodQuizQuest/BollywoodQuizQuest'
import style from './Bollywood.module.css'
export default function BollywoodPage(){
  ...
  const question = useRecoilValue(BollywoodQuestion)
